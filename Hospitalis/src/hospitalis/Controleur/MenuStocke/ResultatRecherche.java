...
public class ResultatRecherche extends javax.swing.JFrame {
     ...
     */
    private static ResultatRecherche instance;
    public ResultatRecherche() {
        initComponents();
    }

    public static ResultatRecherche getInstance() {
        if (instance == null) {
            synchronized (ResultatRecherche.class) {
                if (instance == null) {
                    instance = new ResultatRecherche();
                }
            }
        }
        return instance;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Article Trouvés");
